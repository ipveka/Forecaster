...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="W",
        help="Data frequency: D (daily), W (weekly), or M (monthly)",
    )
    parser.add_argument(
        "--horizon", type=int, default=12, help="Horizon for forecasting"
    )
    parser.add_argument(
        "--n_cutoffs", type=int, default=3, help="Number of cutoffs for backtesting"
    )
    parser.add_argument(
